...
in the sheet's "Photos of product & packaging" column (column M), named
<drive_file_id>.<ext> (any extension — sips will detect the real format).
...
COL = dict(
    ...
    marketing=9, source=10, sample_selection=11, photos=12,
